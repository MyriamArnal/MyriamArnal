...
if number >= 1:   
    ...
    Amp = st.sidebar.slider('Amplitude', 0., 400., 5.)
    Sig = st.sidebar.slider('Sigma', 0., 1.0, 0.01)
    Cent = st.sidebar.slider('Centre', 0., 2.5, 0.2)
...
if number >= 2:    
    ...
    Amp2 = st.sidebar.slider('Amplitude 2', 0., 400., 5.)
    Sig2 = st.sidebar.slider('Sigma 2', 0., 1.0, 0.01)
    Cent2 = st.sidebar.slider('Centre 2', 0., 2.5, 0.2)
...
if number >= 3: 
    ...
    Amp3 = st.sidebar.slider('Amplitude 3', 0., 100., 5.)
    Sig3 = st.sidebar.slider('Sigma 3', 0., 1.0, 0.01)
    Cent3 = st.sidebar.slider('Centre 3', 0., 2.5, 0.2)
...
if uploaded_file is not None:
     ...
     if result.redchi < 25 :
         ...
         if number >= 2: 
             ...
             p.line(x_array, gauss2, legend_label='gauss2', line_color = 'green', line_dash='dashed', line_width=2)
         if number >= 3: 
             ...
             p.line(x_array, gauss3, legend_label='gauss3', line_color = 'grey', line_dash='dashed', line_width=2)  
